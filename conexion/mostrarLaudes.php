...
$registro = mysql_query("SELECT * FROM Breviario WHERE Day='$fechaDia' AND Month='$fechaMes' AND Type = 'Laudes'") or die("Problemas al consultar la base de datos".mysql_error());
