		...
		init : function( options )
		{
			...
			var menuItems = { 'fonteffects': true,
						   ...
						   'insert_link': { "modal": true,
											...
											"icon":"fa fa-link", 
											"tooltip": "Insert Link", 
											"modalHeader": "Crear Hipervinculo",
											"modalBody": $('<div/>',{   class:"form-group"
																	}).append($('<div/>',{
																		id :"errMsg"
																	})).append($('<h5>Digite el texto del Hipervinculo a crear</h5>',{	
																	})).append($('<input/>',{
																		type:"text",
																		id:"inputText",
																		required:true,
																	...
																	})).append($('<h5>Digite el identificador del Hipervinculo comenzando por #, no coloque solo numeros ni repita identificadores</h5>',{	
																	})).append($('<input/>',{
																		type:"text",
																		id:"inputUrl",
																		required:true,
											...
											"onSave":function(){
												...
												if(navigator.userAgent.match(/MSIE/i)){	
													var targetLink='<a href="'+targetURL+'">'+targetText+'</a>';
												...
												$(editorObj).data("editor").find('a[href="'+targetURL+'"]').each(function(){ $(this).attr("target", ""); });
												$(".alert").alert("close");
